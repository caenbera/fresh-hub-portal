    ...
    <section id="cotizacion" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">{t('contact_forms_title')}</h2>
                <p className="text-base sm:text-lg text-gray-600">{t('contact_forms_subtitle')}</p>
            </div>
            <div className="grid md:grid-cols-2 gap-12">
                {/* Cotización Form */}
                <div className="bg-green-50 p-6 md:p-8 rounded-xl border border-green-200">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-6 text-center flex items-center justify-center gap-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-primary text-primary-foreground py-2.5 text-base font-bold hover:bg-green-700 transition h-auto">
                ...
                <div id="formulario-muestra" className="bg-orange-50 p-6 md:p-8 rounded-xl border border-orange-200">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-accent text-accent-foreground py-2.5 text-base font-bold hover:bg-orange-600 transition h-auto">
