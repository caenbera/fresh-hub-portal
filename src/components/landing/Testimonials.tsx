    ...
    <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">{t('testimonials_title')}</h2>
                <p className="text-base sm:text-lg text-gray-600">{t('testimonials_subtitle')}</p>
            </div>
