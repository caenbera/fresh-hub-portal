    ...
    <section className="py-16 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">{t('bridge_title')}</h2>
                <p className="text-base sm:text-lg text-gray-300">{t('bridge_subtitle')}</p>
            </div>
            <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-red-900 bg-opacity-50 p-6 md:p-8 rounded-xl border border-red-500">
                    <div className="text-center mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl font-bold text-red-300">{t('bridge_before_title')}</h3>
                    </div>
                ...
                <div className="bg-green-900 bg-opacity-50 p-6 md:p-8 rounded-xl border border-green-500">
                    <div className="text-center mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl font-bold text-green-300">{t('bridge_after_title')}</h3>
                    </div>
            ...
            <div className="text-center mt-12">
                <div className="bg-accent p-6 rounded-xl inline-block">
                    <h3 className="text-lg sm:text-xl font-bold mb-2">{t('bridge_the_bridge_title')}</h3>
                    <p className="text-base">{t('bridge_the_bridge_desc')}</p>
                </div>
            </div>
        </div>
    </section>
