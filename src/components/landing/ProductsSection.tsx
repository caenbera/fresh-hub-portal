    ...
    <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">{t('products_section_title')}</h2>
                <p className="text-base sm:text-lg text-gray-600">{t('products_section_subtitle')}</p>
            </div>
              ...
              {products.map((product) => (
                <Card key={product.title} className="p-4 md:p-6 rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl text-center">
                    ...
                    <CardHeader className="p-0">
                      <CardTitle className="text-base font-bold mb-3">{product.title}</CardTitle>
                    </CardHeader>
            ...
            <div className="text-center mt-12">
                <p className="text-base sm:text-lg text-gray-700 mb-4">{t('products_section_cta_prompt')}</p>
